...
const TopArea: React.FC<IProps> = () => {
  ...
  // useEffect(() => {
  //   if (config.promoLanguage.includes(langCode)) {
  //     if (notShowSticky) {
  //       dispatch(setShowSticky(false))
  //     } else {
  //       dispatch(setShowSticky(true))
  //     }
  //   }
  //   return () => {
  //     dispatch(setShowSticky(false))
  //   }
  // }, [dispatch, langCode, notShowSticky])

  // console.debug(`Render Section`, { showSticky })
